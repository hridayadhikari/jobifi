...
<header class="bg-white border-b h-20 px-8 flex items-center justify-between">
    ...
    <div class="w-96">
        <input
            type="text"
            placeholder="Search..."
            class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition"
        >
    </div>
