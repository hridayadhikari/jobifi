...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function renderSkills() {
            ...
            pills.forEach(pill => {
                const skillId = Number(pill.dataset.id);
                pill.classList.toggle('bg-black text-white border-black', selectedSkills.includes(skillId));
                pill.classList.toggle('bg-white text-gray-700', !selectedSkills.includes(skillId));
            });
