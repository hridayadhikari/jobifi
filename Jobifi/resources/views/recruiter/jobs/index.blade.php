                ...
                <div class="relative">
                    <form method="GET" class="relative">
                        ...
                        <select name="status" onchange="this.form.submit()"
                            class="appearance-none rounded-md border border-gray-300 bg-white pl-4 pr-10 py-2 text-sm text-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-black cursor-pointer">
                ...
                <div class="rounded-xl border border-dashed border-gray-300 bg-white p-12 text-center shadow-sm">
                    <svg class="mx-auto mb-4 h-10 w-10 text-gray-300" fill="none" stroke="currentColor"
                        ...
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M20 13V7a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v6m16 0v5a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2v-5m16 0H4" />
                    </svg>
                    ...
                    @foreach ($jobs as $job)
                        ...
                        <div class="flex items-center gap-4 px-6 py-5">
                            ...
                            <div class="flex-shrink-0 h-11 w-11 rounded-lg bg-gray-100 flex items-center justify-center">
                                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" stroke-width="1.8"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div
                                    class="mt-1 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-gray-400 font-medium uppercase tracking-wide">
                                    {{-- Applicants --}}
                                    <span class="inline-flex items-center gap-1">
                                        <svg class="h-3.5 w-3.5" fill="none" stroke="currentColor" stroke-width="2"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M17 20h5v-2a4 4 0 0 0-4-4h-1M9 20H4v-2a4 4 0 0 1 4-4h1m4-4a4 4 0 1 1-8 0 4 4 0 0 1 8 0zm6 4a3 3 0 1 0-6 0" />
                                        </svg>
                                    ...
                                    <span class="inline-flex items-center gap-1">
                                        <svg class="h-3.5 w-3.5" fill="none" stroke="currentColor" stroke-width="2"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M17.657 16.657A8 8 0 1 1 6.343 5.343" />
                                        </svg>
                            ...
                            <div class="flex-shrink-0">
                                @if ($status === 'active')
                                    <span
                                        class="inline-block rounded px-3 py-1 text-xs font-bold uppercase tracking-widest bg-black text-white">
                                        Active
                                    </span>
                                @elseif($status === 'closed')
                                    <span
                                        class="inline-block rounded px-3 py-1 text-xs font-bold uppercase tracking-widest border border-gray-300 text-gray-600">
                                        Closed
                                    </span>
                                @else
                                    <span
                                        class="inline-block rounded px-3 py-1 text-xs font-bold uppercase tracking-widest border border-yellow-400 text-yellow-600">
                                        Inactive
                                    </span>
                                @endif
                            </div>
