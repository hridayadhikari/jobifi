    ...
    <div class="bg-white border border-gray-200 rounded-xl p-8 mb-8">
        ...
        <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
            ...
            <div class="flex gap-3">
                ...
                <button
                    class="bg-black text-white px-8 py-3 rounded-lg font-medium hover:bg-slate-800 transition">
            ...
            <div class="bg-white border border-gray-200 rounded-xl overflow-hidden mb-6">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span
                            class="px-3 py-1 rounded-full text-xs bg-slate-100 font-medium">
                ...
                <div class="p-6">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        @forelse($job->skills as $skill)
                            ...
                            <span
                                class="px-4 py-2 bg-slate-100 text-slate-700 rounded-full text-sm font-medium">
