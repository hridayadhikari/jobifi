...
<body class="bg-[#f8f9fa] min-h-screen font-sans text-slate-900 selection:bg-black selection:text-white">
            ...
            <div class="flex items-center gap-4">
                ...
                @auth
                    <a href="{{ route(Auth::user()->role . '.dashboard') }}"
                        class="text-[13px] font-bold text-slate-600 hover:text-black uppercase tracking-wider transition">
                        Dashboard
                    </a>
                @endauth
                ...
                @guest
                    <a href="{{ route('login') }}"
                        class="hidden md:inline-block text-[13px] font-bold text-slate-600 hover:text-black uppercase tracking-wider transition">
                        Sign In
                    </a>

                    <a href="{{ route('register') }}"
                        class="px-6 py-2.5 bg-black text-white text-[13px] font-bold hover:bg-[#1a1a1a] transition duration-200">
                        Get Started
                    </a>
                @endguest
            </div>
    ...
    <section class="pt-32 pb-20 px-6 bg-dots relative overflow-hidden">
        <div class="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center pt-10">
            ...
            <div class="relative z-10">
                ...
                <h1
                    class="text-[48px] md:text-[64px] font-extrabold text-[#0a192f] tracking-tighter leading-[1.05] mb-6">
                    Find Your Dream Job with Jobifi.
                </h1>
                <p class="text-[17px] text-gray-500 leading-relaxed mb-10 max-w-md">
                    Connecting talented professionals with top employers. A streamlined, secure, and beautiful platform
                    to manage your career journey.
                </p>
                ...
                <div class="flex flex-col sm:flex-row items-center gap-4">
                    ...
                    @guest
                        <a href="{{ route('register') }}"
                            class="w-full sm:w-auto px-8 py-3.5 bg-black border-2 border-black text-white text-[14px] font-bold text-center hover:bg-[#1a1a1a] transition duration-200">
                            Start Searching
                        </a>
                    @endguest
                    ...
                    @auth
                        ...
                        @else
                            <button type="button" onclick="showSeekerAlert()"
                                class="w-full sm:w-auto px-8 py-3.5 bg-black border-2 border-black text-white text-[14px] font-bold text-center hover:bg-[#1a1a1a] transition duration-200">
                                Start Searching
                            </button>
                        @endif
                    ...
                    @guest
                        <a href="{{ route('register') }}"
                            class="w-full sm:w-auto px-8 py-3.5 bg-white border-2 border-gray-200 text-black text-[14px] font-bold text-center hover:border-black transition duration-200">
                            Post a Job
                        </a>
                    @endguest
                    ...
                    @auth
                        ...
                        @else
                            <button type="button" onclick="showRecruiterAlert()"
                                class="w-full sm:w-auto px-8 py-3.5 bg-white border-2 border-gray-200 text-black text-[14px] font-bold text-center hover:border-black transition duration-200">
                                Post a Job
                            </button>
                        @endif
            ...
            <div class="relative hidden lg:block h-[500px]">
                ...
                <div
                    class="absolute top-10 right-0 w-80 bg-white border border-gray-200 shadow-xl p-6 transform rotate-3 hover:rotate-0 transition duration-500 z-20">
                    ...
                    <div
                        class="inline-block border border-black px-3 py-1 text-[10px] font-bold text-black uppercase tracking-widest mt-2">
                        Shortlisted
                    </div>
                </div>

                <div
                    class="absolute top-40 right-20 w-80 bg-white border border-gray-200 shadow-xl p-6 transform -rotate-2 hover:rotate-0 transition duration-500 z-10">
    ...
    <section class="py-24 px-6 bg-[#f8f9fa]">
        <div class="max-w-[1200px] mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                {{-- Feature 1 --}}
                <div
                    class="bg-white border border-gray-200 shadow-sm p-8 hover:border-gray-400 transition duration-300">
                    ...
                    <p class="text-[13px] text-gray-500 leading-relaxed">
                        Filter by location, role, and requirements to instantly find the perfect match for your
                        skillset.
                    </p>
                </div>
                ...
                <div
                    ...
                    <p class="text-[13px] text-gray-500 leading-relaxed">
                        Apply to top companies with a single click using your securely stored digital resume and
                        profile.
                    </p>
                </div>
        ...
        <div class="max-w-[1000px] mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
                ...
                <div class="relative z-10 text-center flex flex-col items-center">
                    <div
                        class="w-12 h-12 bg-black text-white rounded-full flex items-center justify-center text-[18px] font-bold mb-6 border-4 border-white shadow-sm">
                        1
                    </div>
                ...
                <div class="relative z-10 text-center flex flex-col items-center">
                    <div
                        class="w-12 h-12 bg-white text-black border border-gray-200 rounded-full flex items-center justify-center text-[18px] font-bold mb-6 shadow-sm">
                        2
                    </div>
    ...
    <section class="py-24 px-6 bg-black text-white text-center">
        <div class="max-w-[800px] mx-auto">
            ...
            @auth
            <a href="{{ route(Auth::user()->role . '.dashboard') }}"
                class="inline-block px-10 py-4 bg-white text-black text-[15px] font-bold hover:bg-gray-100 transition duration-200 shadow-lg">
                Go to Dashboard
            </a>
            @endauth
            @guest
    ...
    <script>
        function showSeekerAlert() {
            Swal.fire({
                icon: 'info',
                title: 'Seeker Access Required',
                text: 'Only job seekers can search and apply for jobs.',
                confirmButtonText: 'OK'
            });
        }

        function showRecruiterAlert() {
            Swal.fire({
                icon: 'info',
                title: 'Recruiter Access Required',
                text: 'Only recruiters can post job vacancies.',
                confirmButtonText: 'OK'
            });
        }
    </script>
