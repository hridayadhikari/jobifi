        ...
        <div class="max-w-[1200px] mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                ...
                <div class="bg-white border border-gray-200 shadow-sm p-6 relative">
                    ...
                    <p class="text-[28px] font-extrabold text-slate-900 leading-none mb-2">
                        {{ number_format($stats['recruiters']) }}
                    </p>
                        ...
                        @forelse($recentUsers as $user)
                            <div class="flex items-center justify-between group">
                                <div class="flex items-center gap-5">
                                    <div
                                        class="w-10 h-10 bg-gray-50 border border-gray-200 rounded-full flex items-center justify-center shrink-0">
                                        <ion-icon name="time-outline" class="text-lg text-gray-400"></ion-icon>
                                    </div>
                                    <div>
                                        <p class="text-[14px] font-bold text-[#0a192f]">
                                             {{ ucfirst($user->role) }} registered
                                        </p>
                ...
                <div class="bg-white border border-gray-200 shadow-sm h-fit">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        <div class="flex justify-between items-center bg-gray-50/80 p-5 rounded-md">
                            ...
                            <span
                                class="bg-black text-white px-3 py-1 text-[11px] font-bold uppercase tracking-widest rounded-sm">
                                Operational
                            </span>
                        </div>
                        ...
                        <div class="flex justify-between items-center bg-gray-50/80 p-5 rounded-md">
                            ...
                            <span
                                class="border border-black text-black px-3 py-1 text-[11px] font-bold uppercase tracking-widest rounded-sm">
                                0 Today
                            </span>
                        </div>
