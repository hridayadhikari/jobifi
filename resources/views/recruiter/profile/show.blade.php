...
@section('content')
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden mb-5">
        ...
        {{-- Banner --}}
        <div
            class="relative h-36 bg-gradient-to-r from-slate-200 to-slate-300 flex items-center justify-center overflow-hidden">
        ...
        <div class="px-6 pb-5">
            <div class="flex items-end justify-between -mt-10 mb-4">
                ...
                {{-- Company Logo --}}
                <div
                    class="relative z-10 w-20 h-20 rounded-xl ring-4 ring-white shadow-md shrink-0 overflow-hidden bg-gray-100 flex items-center justify-center border border-gray-200">
                    @if ($user->company && $user->company->logo_path)
                        <img src="{{ asset('storage/' . $user->company->logo_path) }}" class="w-full h-full object-cover"
        ...
        <div class="col-span-2 space-y-5">
            ...
            @if ($user->company && $user->company->description)
                <div class="bg-white rounded-xl border border-gray-200 p-6">
                    ...
                    <p class="text-sm text-gray-600 leading-relaxed whitespace-pre-line">{{ $user->company->description }}
                    </p>
                </div>
            @endif
                ...
                @if ($jobs->count())
                    <div class="space-y-1">
                        @foreach ($jobs->take(5) as $job)
                            <a href="#"
                                ...
                                <div>
                                    <p class="font-semibold text-gray-900 text-sm group-hover:text-gray-700">
                                        {{ $job->title }}</p>
                                ...
                                <svg class="w-4 h-4 text-gray-300 group-hover:text-gray-500 shrink-0 ml-3 transition"
                    ...
                    @if ($totalJobs > 5)
                        <div class="mt-5 pt-4 border-t border-gray-100 text-center">
                            <a href="#"
                                class="text-xs font-bold tracking-widest text-gray-400 hover:text-gray-600 uppercase transition">
                ...
                <div class="bg-white rounded-xl border border-gray-200 p-5">
                    ...
                    <div class="divide-y divide-gray-100">
                        ...
                        <div class="flex justify-between py-2.5 text-sm">
                            ...
                            <span
                                class="font-semibold text-gray-800">{{ $user->company->headquarters_location ?? '—' }}</span>
                        </div>
                    </div>
                </div>
            @endif
            ...
            @if ($user->designation || $user->phone || $user->email)
                <div class="bg-white rounded-xl border border-gray-200 p-5">
                    ...
                    <div class="flex items-center gap-3 mb-4">
                        <div
                            class="w-11 h-11 rounded-full bg-gray-100 flex items-center justify-center shrink-0 overflow-hidden ring-2 ring-gray-100">
